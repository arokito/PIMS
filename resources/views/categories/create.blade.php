<x-admin-layout>
    ...
    <div class="py-12 w-full">
       ...
       <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg ">
                <!-- component -->
          <div class="flex  p-2">
              <a href="route('categories.index')" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md ">Back</a>
          </div>
            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{ route('categories.store') }}">
                  ...
                  <div class="sm:col-span-6" >
                    <label for="name" class="block text-sm font-medium text-gray-700"> Aina ya Mchango</label>
                    <div class="mt-1">
