            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex p-2">
                    <a href="{{ route('communities.index') }}"
                        class="px-4 py-2 bg-green-500 hover:bg-green-700 text-slate-100 rounded-md"> CommmunityIndex</a>
                </div>
                <div class="flex flex-col p-2 bg-slate-100">
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form method="POST" action="{{ route('communities.update', $community->id) }}">
                            ...
                            <div class="sm:col-span-6">
                                <label for="zone_id"
                                    class="block text-sm font-medium text-gray-700">Kanda</label>
                                <select id="zone_id" name="zone_id" autocomplete="zone_id-name"
